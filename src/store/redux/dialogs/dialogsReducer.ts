...
import type { DialogsListItemType, GetActionWInferType, IncomingMessageType } from '../storeTypes'
...
export const DialogsAC = {
    ...
    setIsInProgressLoadindDialogsList: (isInProgress: boolean) =>
        ({ type: SET_IS_IN_PROGRESS_LOADING_DIALOGS_LIST, isInProgress } as const),
